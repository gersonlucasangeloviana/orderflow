...
public sealed class OrderFlowDbContext(DbContextOptions<OrderFlowDbContext> options) : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>(options)
{
    public DbSet<ProductEntity> Products => Set<ProductEntity>();
    public DbSet<OrderEntity> Orders => Set<OrderEntity>();
    public DbSet<OrderItemEntity> OrderItems => Set<OrderItemEntity>();
    public DbSet<OutboxMessageEntity> OutboxMessages => Set<OutboxMessageEntity>();
    public DbSet<ProcessedNotificationEntity> ProcessedNotifications => Set<ProcessedNotificationEntity>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ProcessedNotificationEntity>(entity => { entity.HasKey(x => x.MessageId); entity.HasIndex(x => x.OrderId); });
    }
}
...
public sealed class ProcessedNotificationEntity { public Guid MessageId { get; set; } public Guid OrderId { get; set; } public DateTimeOffset ProcessedAt { get; set; } }
public sealed class ApplicationUser : IdentityUser<Guid> { public string? DisplayName { get; set; } }
